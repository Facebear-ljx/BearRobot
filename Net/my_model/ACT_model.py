...
from Net.basic_net.transformer import Transformer, TransformerDecoder, TransformerDecoderLayer, TransformerEncoder, TransformerEncoderLayer
from utils.net.initialization import init_weight
...
class ACTModel(nn.Module):
       def __init__(
              ...
              **kwargs
              ...
              self.register_buffer('pos_table', get_sinusoid_encoding_table(1+1+ac_num, hidden_dim)) # [CLS], qpos, a_seq
