...
torchrun --standalone --nnodes=1 --nproc-per-node=1 train_diffusion_policy_example_libero.py \
    ...
    --save_freq 50000 \
    --T 25 \
    --save_path ../experiments/libero/libero_goal/diffusion/corrupt_0710_01_$text_encoder \
    --log_path ../experiments/libero/libero_goal/diffusion/corrupt_0710_01_$text_encoder \
    --port 2077 \
    --add_noise False \
    --minus_mean True \
...
torchrun --standalone --nnodes=1 --nproc-per-node=1 train_diffusion_policy_example_libero.py \
    ...
    --save_freq 50000 \
    --T 25 \
    --save_path ../experiments/libero/libero_goal/diffusion/corrupt_0711_01_$text_encoder \
    --log_path ../experiments/libero/libero_goal/diffusion/corrupt_0711_01_$text_encoder \
    --port 2077 \
    --add_noise True \
    --minus_mean False \
    --mean_data_path /home/dodo/.zh1hao_space/bear_branch/BearRobot/analysis/libero130_batch64/mean_embeddings_final.npz
