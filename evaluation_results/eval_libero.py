...
def get_args():
        ...
        parser.add_argument('--basic_path', default='/home/dodo/ljx/BearRobot/experiments/libero/libero_goal/diffusion/resnet34_wstate_0706_ff_all600ep_DecisionNCE-V/', type=str, help='path to the checkpoint and statistics and wandb')
        ...
        parser.add_argument('--save_path', default='/home/dodo/ljx/BearRobot/experiments/libero/libero_goal/diffusion/resnet34_wstate_0706_ff_all600ep_DecisionNCE-V/', type=str, help='path to save the evaluation results')
