...
def get_args():
        ...
        parser.add_argument('--basic_path', default='/home/dodo/.zh1hao_space/bear_branch/BearRobot/experiments/libero/libero_goal/diffusion/libero130_lang_1.0_CLIP_noise_0.8_0814/', type=str, help='path to the checkpoint and statistics and wandb')
        parser.add_argument('--statistic_name', default='statistics.json', type=str, help='statistics file name')
        parser.add_argument('--ckpt_name', default='199999_0.6781079769134521.pth', type=str, help='checkpoint file name')
        parser.add_argument('--save_path', default='/home/dodo/.zh1hao_space/bear_branch/BearRobot/experiments/libero/libero_goal/diffusion/libero130_lang_1.0_CLIP_noise_0.8_0814/', type=str, help='path to save the evaluation results')
        parser.add_argument('--json_path', default='/home/dodo/.zh1hao_space/bear_branch/BearRobot/data/libero/libero130-ac.json', type=str, help='path to the json file')
